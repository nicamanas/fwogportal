...
from ..setup.preloaded_data import skill_details, role_details, role_skills, staff_details, role_listings, staff_skills
from ..crud import ljps_crud, lms_crud, rolelistings_crud, sbrp_skill_details_crud, sbrp_staff_skills_crud
